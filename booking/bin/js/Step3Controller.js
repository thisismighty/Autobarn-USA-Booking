...
Step3.controller.insurance_options=function(){
	...
	for (var i in rcmInsuranceOptions) {
		...
		subdesc1 = rcmInsuranceOptions[i].feedescription1 ? '<li>' + rcmInsuranceOptions[i].feedescription1 + '</li>' : '';	
		subdesc2 = rcmInsuranceOptions[i].feedescription2 ? '<li>' + rcmInsuranceOptions[i].feedescription2 + '</li>' : '';	
		subdesc3 = rcmInsuranceOptions[i].feedescription3 ? '<li>' + rcmInsuranceOptions[i].feedescription3 + '</li>' : '';

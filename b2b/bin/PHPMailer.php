...
class PHPMailer
{
    ...
    public function createBody()
    {
        ...
        switch ($this->message_type) {
            case 'inline':
                ...
                $body .= $this->encodeString($this->Body, $bodyEncoding, $this->LeaveBodyAlone);
     ...
     * @return string
     */
    public function encodeString($str, $encoding = 'base64',$leave_alone=false)
    {
		if($leave_alone){
			return $str;
		}
